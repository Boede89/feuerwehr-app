...
if (!empty($db)) {
    ...
    // Einheitenspezifische Einstellungen haben Vorrang
    // Einheit 1 (Legacy): Wenn kein Key in einheit_settings, globalen Key behalten
    // Andere Einheiten: Wenn kein Key in einheit_settings, Key leeren (kein Fallback)
