...
// Globale Einstellungen (Legacy) aus settings – NUR wenn keine Einheit ausgewählt
// Bei Einheitsauswahl (einheit_id > 0) ausschließlich einheit_settings nutzen – kein globaler Key
