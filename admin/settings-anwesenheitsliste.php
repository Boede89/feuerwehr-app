...
<div class="container-fluid mt-4">
    ...
    <form method="POST" id="felderForm">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p class="text-muted small mb-2">Beim Absenden der Anwesenheitsliste erscheint ein Dialog. Hier legen Sie fest, ob die Option „Anwesenheitsliste drucken“ standardmäßig angehakt ist. Standardwerte für Mängelbericht und Gerätewartmitteilung (Erstellen / Drucken) legen Sie in den jeweiligen Formulareinstellungen fest.</p>
                <div class="form-check form-switch mb-2">
                    ...
                    <label class="form-check-label" for="print_after_save_default">„Anwesenheitsliste drucken“ standardmäßig aktiv</label>
                </div>
                <hr>
