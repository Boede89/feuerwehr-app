<?php
/**
 * Debug: Genehmigung vs Button - Warum funktioniert Button aber nicht Genehmigung?
 */
...
echo "<!DOCTYPE html>";
echo "<html><head><title>Debug Approval vs Button</title></head><body>";
echo "<h1>🔍 Debug: Genehmigung vs Button - Warum funktioniert Button aber nicht Genehmigung?</h1>";
...
try {
    ...
    echo "<h2>2. Prüfe ausstehende Reservierungen</h2>";
    ...
    if ($reservation) {
        ...
        echo "<h2>3. Teste Genehmigung (wie im Dashboard)</h2>";
        
        // Simuliere Dashboard-Genehmigung
        $reservation_id = $reservation['id'];
        
        echo "Schritt 1: Reservierung genehmigen<br>";
        ...
        if ($result) {
            ...
            echo "Schritt 2: Reservierung aus Datenbank laden (wie im Dashboard)<br>";
            ...
            if ($reservation_data) {
                ...
                echo "Schritt 3: Google Calendar Event erstellen (wie im Dashboard)<br>";
    ...
    echo "<h2>4. Teste Kalender-Konfliktprüfung (nur für das jeweilige Fahrzeug)</h2>";
    
    if ($reservation) {
        echo "Teste Kalender-Konflikte für Fahrzeug: {$reservation['vehicle_name']}<br>";
        echo "Start: {$reservation['start_datetime']}<br>";
        echo "Ende: {$reservation['end_datetime']}<br>";
        ...
        try {
            ...
            if (empty($conflicts)) {
                echo "✅ Keine Kalender-Konflikte für Fahrzeug '{$reservation['vehicle_name']}' gefunden<br>";
            } else {
                echo "⚠️ Kalender-Konflikte für Fahrzeug '{$reservation['vehicle_name']}' gefunden:<br>";
