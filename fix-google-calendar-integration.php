<?php
/**
 * Fix: Google Calendar Integration reparieren
 */

require_once 'config/database.php';

echo "<!DOCTYPE html>";
echo "<html><head><title>Fix Google Calendar Integration</title></head><body>";
echo "<h1>🔧 Fix: Google Calendar Integration reparieren</h1>";
...
try {
    ...
    echo "<h2>4. Teste Google Calendar Integration direkt</h2>";
    ...
    echo "<h2>5. Teste Reservierungsgenehmigung mit Google Calendar</h2>";
