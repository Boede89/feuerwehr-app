<?php
/**
 * Fix: Google Calendar Integration final mit korrigierter Session
 */

require_once 'config/database.php';

echo "<!DOCTYPE html>";
echo "<html><head><title>Fix Google Calendar Final Session</title></head><body>";
echo "<h1>🔧 Fix: Google Calendar Integration final mit korrigierter Session</h1>";
...
try {
    ...
    if (function_exists('create_google_calendar_event')) {
        ...
        try {
            $test_event_id = create_google_calendar_event(
                'Test Fahrzeug - Final Session',
                'Test Grund - Final Session',
                '2025-10-04 15:00:00',
                '2025-10-04 16:00:00',
                null,
                'Test Ort - Final Session'
            );
    ...
    echo "✅ Session user_id Problem behoben<br>";
