<?php
/**
 * Debug: Dashboard Google Calendar Problem
 */
...
echo "<!DOCTYPE html>";
echo "<html><head><title>Debug Dashboard Google Calendar</title></head><body>";
echo "<h1>🔍 Debug: Dashboard Google Calendar Problem</h1>";
echo "<p>Zeitstempel: " . date('d.m.Y H:i:s') . "</p>";

try {
    echo "<h2>1. Setze Session-Werte (wie im Dashboard)</h2>";
    ...
    echo "<h2>2. Simuliere Dashboard-Genehmigung genau</h2>";
    ...
    if ($reservation) {
        ...
        // Simuliere Dashboard-Genehmigung (genau wie im Code)
        $reservation_id = $reservation['id']; // Wie im Dashboard
        ...
        if ($result) {
            ...
            echo "<h3>Schritt 2: Reservierung aus Datenbank laden (wie im Dashboard)</h3>";
            ...
            if ($reservation_data) {
                ...
                echo "<h3>Schritt 3: Google Calendar Event erstellen (wie im Dashboard)</h3>";
