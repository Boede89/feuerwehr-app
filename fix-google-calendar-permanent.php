<?php
/**
 * Fix: Google Calendar Integration permanent reparieren
 */

require_once 'config/database.php';

echo "<!DOCTYPE html>";
echo "<html><head><title>Fix Google Calendar Permanent</title></head><body>";
echo "<h1>🔧 Fix: Google Calendar Integration permanent reparieren</h1>";
...
try {
    ...
    echo "<h2>2. Lade includes/functions.php explizit</h2>";
    
    if (file_exists('includes/functions.php')) {
        echo "✅ includes/functions.php existiert<br>";
        
        // Lade functions.php explizit
    ...
    echo "<h2>3. Lade Google Calendar Klassen explizit</h2>";
    ...
    if (function_exists('create_google_calendar_event')) {
        ...
        try {
            $test_event_id = create_google_calendar_event(
                'Test Fahrzeug - Permanent Fix',
                'Test Grund - Permanent Fix',
                '2025-10-04 15:00:00',
                '2025-10-04 16:00:00',
                null,
                'Test Ort - Permanent Fix'
            );
...
?>';
    ...
    echo "✅ Session-Problem dauerhaft behoben<br>";
