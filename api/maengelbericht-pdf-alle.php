...
foreach ($berichte as $bericht) {
    ...
    <div class="mb-page" style="page-break-after: always;">
        ...
        <div class="section geraetewart-section">
            ...
            <div style="margin-top: 12px;"><label style="font-weight: bold;">Weitere Veranlassung</label><div class="veranlassung-line"></div><div class="veranlassung-line"></div><div class="veranlassung-line"></div></div>
            <div class="line-field" style="margin-top: 12px;"><label>Mangel beseitigt am:</label><div class="line"></div></div>
