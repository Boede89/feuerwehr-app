<?php
/**
 * Gespeicherten Anhang einer Anwesenheitsliste ausliefern (Formularcenter / Bearbeiten).
 */
session_start();
...
try {
    ...
    $stmt->execute([$anhang_id, 'anwesenheitsliste', $list_id]);
